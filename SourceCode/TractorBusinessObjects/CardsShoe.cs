...
namespace Duan.Xiugang.Tractor.Objects
{
    ...
    public class CardsShoe
    {
        ...
        {
            Cards = new int[] { 0, 7, 33, 24, 0, 40, 20, 7, 24, 49, 2, 50, 41, 4, 46, 46, 19, 17, 35, 21, 43, 48, 22, 11, 23, 16, 13, 28, 6, 13, 22, 6, 12, 17, 3, 18, 39, 52, 48, 3, 10, 10, 34, 37, 14, 43, 1, 30, 51, 1, 38, 33, 38, 47, 9, 28, 27, 29, 12, 31, 47, 16, 36, 25, 23, 19, 27, 32, 37, 29, 52, 32, 44, 34, 25, 20, 44, 49, 8, 40, 26, 5, 51, 8, 4, 15, 53, 5, 9, 39, 53, 31, 30, 42, 50, 45, 14, 35, 21, 36, 2, 45, 18, 11, 15, 42, 26, 41 };
        }
        ...
        {
            Cards = new int[] { 11, 0, 39, 52, 36, 44, 20, 13, 35, 1, 2, 16, 23, 46, 35, 4, 49, 50, 38, 48, 34, 30, 49, 6, 10, 0, 24, 44, 19, 31, 47, 18, 13, 25, 42, 45, 21, 45, 15, 22, 8, 26, 33, 52, 31, 40, 50, 51, 29, 12, 10, 7, 7, 5, 34, 37, 32, 24, 36, 4, 3, 53, 5, 29, 30, 37, 12, 41, 28, 11, 28, 40, 9, 53, 32, 6, 2, 46, 17, 9, 15, 14, 20, 8, 51, 47, 25, 48, 43, 38, 41, 1, 16, 23, 22, 42, 26, 33, 19, 27, 17, 27, 3, 14, 18, 21, 39, 43 };
        }
        ...
        public void TestSet10SamePlayerDoubleExpose()
        {
            Cards = new int[] { 4, 0, 12, 52, 25, 42, 17, 46, 16, 24, 33, 25, 32, 49, 52, 22, 29, 34, 11, 30, 53, 12, 20, 19, 1, 47, 40, 15, 13, 10, 50, 31, 1, 37, 6, 14, 24, 36, 36, 5, 20, 0, 38, 39, 49, 8, 3, 27, 22, 45, 18, 48, 23, 21, 38, 46, 47, 9, 21, 51, 28, 37, 2, 15, 32, 34, 16, 10, 11, 39, 17, 26, 13, 43, 18, 6, 41, 44, 41, 30, 3, 7, 48, 7, 44, 4, 45, 53, 9, 31, 33, 26, 5, 29, 51, 2, 42, 19, 35, 35, 28, 27, 50, 14, 40, 43, 23, 8 };
        }
